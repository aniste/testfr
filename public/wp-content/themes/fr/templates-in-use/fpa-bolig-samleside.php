<?php /* Template name: FPA bolig */ get_header(); ?>
					...
					<section class="pressemeldinger vimener p-0-20">
						<?php
								...
								$args = array(
								    ...
								    'posts_per_page' => 2,
								    'tag' => 'vi-mener',
								    'category_name' => 'fpa-bolig, fpa-bolig-2015',
								    // 'year' => $current_year, 2015,
								    'orderby' => 'post_date',
									'order' => 'DESC',
								);
								...
								while ($presse_query->have_posts()) : $presse_query->the_post();
								    ...
								    echo '<div class="child">';
								    	$importedID = $post->ID;?>
								  		...
								  		<div class="col-l">
								    	<?php echo '<a href="' . rewrite_post_parmalink(get_permalink()) .'">' . '<h3>' . $post->post_title ?> </h3>

								    	<p>
										<?php $ingressteksten = CFS()->get('ingress');
									    	if ($ingressteksten != '') {echo $ingressteksten;} ?>
										</p></a>

								    	<?php echo '<a href="' . rewrite_post_parmalink(get_permalink()) .'">' . '<div class="les_mer">Les hele saken</div>';
										...
										echo '</div>';
										echo '<div class="clear"></div></div>';
								    echo '</a><div class="clear"></div></div>';
								endwhile;
								wp_reset_postdata();
							?>
							<div class="clear"></div>
							    ...
							    <div class="dropdown-collapse">
							    	<div class="dropdown-child-excerpt">
								    	<?php
										   function posts_by_year() {
											  ...
											  $posts = get_posts(array(
											    ...
											    // ),
											    'category_name' => 'fpa-bolig,fpa-bolig-2010,fpa-bolig-2011,fpa-bolig-2012,fpa-bolig-2013,fpa-bolig-2014, fpa-bolig-2015',
											  ));
										...
										<?php foreach(posts_by_year() as $year => $posts) : ?>
										  <h4 class="yeardivider"><?php echo $year; ?></h4>
								...
								echo '<div class="child">
									<div class="col-l">';
										...
										$ingressteksten = CFS()->get('ingress', $post_id);
									    	if ($ingressteksten != '') {echo $ingressteksten;}
										echo '</p><div class="les_mer">Les hele saken</div>';
									    ...
									    <?php foreach($posts as $post) : setup_postdata($post); ?>
										     ...
										     <?php
											      echo '<div class="child">';
											    	...
											    	echo '<a class="ingresslink" href="' . get_permalink() .'">' . '<p>' . $post->post_excerpt . '</p></a>';
