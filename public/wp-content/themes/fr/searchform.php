<!-- search -->
<form id="fbr-searchform" class="search" method="get" action="<?php echo home_url(); ?>" role="search">
    <input autocomplete="off" id="fbr-keyword" name="s" type="text" value="<?php echo get_search_query() ?>" placeholder="SØK"/><a style="top: -25px;" href="#">
