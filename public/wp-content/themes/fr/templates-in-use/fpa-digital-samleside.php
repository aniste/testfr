<?php /* Template name: FPA Digital */ get_header(); ?>
					...
					<section class="pressemeldinger vimener p-0-20">
						<?php
								...
								$args = array(
								    ...
								    'posts_per_page' => 2,
								    'tag' => 'vi-mener',
								    'category_name' => 'fpa-digital, fpa-digital-2015',
								    // 'year' => $current_year,
								    'orderby' => 'post_date',
									'order' => 'DESC',
								);
								    	...
								    	<?php
										   function posts_by_year() {
											  ...
											  $posts = get_posts(array(
											    ...
											    // ),
											    'category_name' => 'fpa-digital,fpa-digital-2010,fpa-digital-2011,fpa-digital-2012,fpa-digital-2013,fpa-digital-2014, fpa-digital-2015',
											  ));
