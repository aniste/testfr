<?php /* Template name: FPA Finans */ get_header(); ?>
					...
					<section class="pressemeldinger vimener p-0-20">
						<?php
								...
								$args = array(
								    ...
								    'posts_per_page' => 2,
								    'tag' => 'vi-mener',
								    'category_name' => 'fpa-finans, fpa-finans-2015',
								    //'year' => $current_year,
								    'orderby' => 'post_date',
									'order' => 'DESC',
								);
								    	...
								    	<?php
										   function posts_by_year() {
											  ...
											  $posts = get_posts(array(
											    ...
											    // ),
											    'category_name' => 'fpa-finans,fpa-finans-2010,fpa-finans-2011,fpa-finans-2012,fpa-finans-2013,fpa-finans-2014, fpa-finans-2015',
											  ));
